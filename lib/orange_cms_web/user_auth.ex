defmodule OrangeCmsWeb.UserAuth do
  @moduledoc false
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_orange_cms_web_user_remember_me"
  ...
  def fetch_current_user(conn, _opts) do
    ...
    |> assign(:context, OrangeCms.Context.new(user: user))
  end
  ...
  the current_user:
      ...
      defmodule OrangeCmsWeb.PageLive do
        use OrangeCmsWeb, :live_view

        on_mount {OrangeCmsWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{OrangeCmsWeb.UserAuth, :ensure_authenticated}] do
