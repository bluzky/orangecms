defmodule OrangeCmsWeb.UserAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OrangeCmsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    test "erases session and cookies", %{conn: conn, user: user} do
      user_token = Accounts.log_in_user(user)
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OrangeCmsWeb.Endpoint.subscribe(live_socket_id)
